...
export const mockPurchaseRequests: PurchaseRequest[] = [
  {
    ...
    recommendedSupplierId: 's3', recommendedSupplierReason: '绿源砂石料场交期1天、评分4.5、单价85元/立方米，综合最优',
  ...
  },
  {
    ...
    recommendedSupplierId: 's4', recommendedSupplierReason: '恒泰木业为该物料原供应商，交期5天、评分4.3',
...
export const mockInventoryTransactions: InventoryTransaction[] = [
  { id: 'it1', materialId: 'm1', materialName: 'HRB400E螺纹钢', type: 'stock_in', quantity: 300, unit: '吨', reason: '采购到货入库', relatedId: 'p0', operatorId: 'u3', operatorName: '王强', timestamp: '2026-06-15 08:30:00' },
  { id: 'it2', materialId: 'm5', materialName: '松木模板', type: 'stock_in', quantity: 100, unit: '张', reason: '采购到货入库', relatedId: 'p0b', operatorId: 'u3', operatorName: '王强', timestamp: '2026-06-10 09:00:00' },
  { id: 'it3', materialId: 'm5', materialName: '松木模板', type: 'stock_out', quantity: 58, unit: '张', reason: '质检不合格扣减', relatedId: 'i1', operatorId: 'u2', operatorName: '李明', timestamp: '2026-06-19 14:30:00' },
  { id: 'it4', materialId: 'm1', materialName: 'HRB400E螺纹钢', type: 'stock_out', quantity: 15, unit: '吨', reason: '吊运消耗至3F作业面', relatedId: 't1', operatorId: 'u1', operatorName: '张伟', timestamp: '2026-06-20 10:30:00' },
  { id: 'it5', materialId: 'm3', materialName: '河沙(中粗)', type: 'stock_in', quantity: 200, unit: '立方米', reason: '采购到货入库', relatedId: 'p0c', operatorId: 'u3', operatorName: '王强', timestamp: '2026-06-19 07:00:00' },
  { id: 'it6', materialId: 'm3', materialName: '河沙(中粗)', type: 'stock_out', quantity: 115, unit: '立方米', reason: '日常施工消耗', relatedId: 'd1', operatorId: 'u1', operatorName: '张伟', timestamp: '2026-06-20 10:00:00' },
];
